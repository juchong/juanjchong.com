...
{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/nes_cpu_table.png){% endraw %}

{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/unused_n64_signals.PNG){% endraw %}
...
{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/sitting_idle.png){% endraw %}

This image shows how much the controller polling time changes depending on CPU load.

{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/messy_timing.png){% endraw %}
...
{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/cpu_busy_snip.png){% endraw %}

Here are a few pictures of the N64's current state now that I've added test points. 

{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/21-02-21 23-31-33 7169-min.jpg){% endraw %}

{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/21-02-21 23-31-39 7170-min.jpg){% endraw %}

{% raw %}![alt]({{ site.url }}{{ site.baseurl }}/assets/images/21-02-21 23-31-46 7171-min.jpg){% endraw %}