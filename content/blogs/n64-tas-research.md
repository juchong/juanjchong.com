...
![OpenOCD Successfully Connecting to the N64 CPU!](/images/n64/openocd_gdb_ubuntu.png)
...
![Retail N64 JTAG Interface Schematic](/images/n64/N64_JTAG_JuanC_RevA.JPG)
...
![TDO Signal Before Buffering](/images/n64/image_pre_opamp.png)
...
![TDO Signal After Buffering](/images/n64/image_post_opamp.png)
...
![N64 CPU Pins](/images/n64/unused_n64_signals.PNG)
...
![DK64 Sitting Idle](/images/n64/sitting_idle.png)

This image shows how much the controller polling time changes depending on CPU load.

![DK64 Messy Timing](/images/n64/messy_timing.png)
...
![N64 CPU When Busy](/images/n64/cpu_busy_snip.png)
